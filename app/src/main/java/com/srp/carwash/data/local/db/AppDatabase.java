...
package com.srp.carwash.data.local.db;

import androidx.room.Database;
import androidx.room.RoomDatabase;

import com.srp.carwash.data.local.db.dao.OptionDao;
import com.srp.carwash.data.local.db.dao.QuestionDao;
import com.srp.carwash.data.local.db.dao.UserDao;
